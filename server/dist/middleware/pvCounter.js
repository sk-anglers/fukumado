...
exports.createPVCounterMiddleware = createPVCounterMiddleware;
/**
...
function isBot(userAgent) {
    if (!userAgent)
        return true; // User-Agentがない場合はボット扱い
 ...
 * PVカウントミドルウェアを作成
 */
function createPVCounterMiddleware(pvTracker) {
...
//# sourceMappingURL=pvCounter.js.map