 ...
 * 利用規約を取得
 */
exports.legalRouter.get('/terms', (req, res) => {
    try {
        res.json({
            ...TERMS_OF_SERVICE,
            type: 'terms'
 ...
 * プライバシーポリシーを取得
 */
exports.legalRouter.get('/privacy', (req, res) => {
    try {
        res.json({
            ...PRIVACY_POLICY,
            type: 'privacy'
 ...
 * 文書バージョン情報を取得
 */
exports.legalRouter.get('/versions', (req, res) => {
    try {
        res.json({
            terms: {
 ...
 */
exports.legalRouter.get('/all', (req, res) => {
    try {
        res.json({
