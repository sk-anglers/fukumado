...
class SystemMetricsCollector {
    ...
    calculateCpuUsage() {
        ...
        // CPU時間の差分を計算（マイクロ秒 → 秒）
        const cpuTimeDelta = (currentCpuUsage.user - this.previousCpuUsage.user +
...
// シングルトンインスタンス
exports.systemMetricsCollector = new SystemMetricsCollector();
//# sourceMappingURL=systemMetricsCollector.js.map